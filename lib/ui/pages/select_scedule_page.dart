...
class SelectScedulePage extends StatefulWidget {
  final MovieDetail movieDetail;
  SelectScedulePage(this.movieDetail);
  @override
  _SelectScedulePageState createState() => _SelectScedulePageState();
}

class _SelectScedulePageState extends State<SelectScedulePage> {
  List<DateTime> dates;
                ...
                Align(
                  ...
                  child: BlocBuilder<UserBloc, UserState>(
                    builder: (_, userState) => FloatingActionButton(
                      elevation: 0,
                      backgroundColor: (isValid) ? mainColor : Color(0xFEE4E4E4),
